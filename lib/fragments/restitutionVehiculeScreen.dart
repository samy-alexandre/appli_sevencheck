...
class RestitutionVehiculeScreen extends StatefulWidget {
  static const String routeName = '/RetraitVehiculeScreen';

  @override
  _RestitutionVehiculeScreenState createState() =>
      _RestitutionVehiculeScreenState();
}

class _RestitutionVehiculeScreenState extends State<RestitutionVehiculeScreen> {
  TextStyle style =
